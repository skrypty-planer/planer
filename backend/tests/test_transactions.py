...
def add_test_transaction(user_id=1, name="Test Income", amount=100, tx_type="income", category="Pensja"):
    """
...
def test_get_summary_success(client, app):
    ...
    add_test_user(user_id=1)
    add_test_transaction(user_id=1)
